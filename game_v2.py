...
def random_predict(number: int = 1) -> int:
    ...
    """
    count = 0
    low_bord = 1   #Задаем исходную нижнюю границу
    high_bord = 101  #Задаем исходную верхнюю границу

    while True:
        count += 1
        predict_number = np.random.randint(low_bord, high_bord)  # предполагаемое число
